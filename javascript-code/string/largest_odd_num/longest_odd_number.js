...
function largestOddRemoveZero(num) {
    ...
    for (let i = num.length - 1; i >= 0; i--) {
        if ((num[i] - '0') % 2 === 1) {
            ind = i;//Store the index i inside the variable ind.
// Meaning:i = the position where we found an odd digit
// ind = remembers that position 
// "42059"
//    ↑
// i = 3   (digit '5' is odd); ind = i;   // ind = 3
            break
        }
    }
